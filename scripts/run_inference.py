...
@hydra.main(version_base=None, config_path="../config/inference", config_name="curve")
def main(conf: HydraConfig) -> None:
    ...
    for i_des in range(design_startnum, design_startnum + sampler.inf_conf.num_designs):
        ...
        for t in range(int(sampler.t_step_input), sampler.inf_conf.final_step - 1, -1):
            # for t in range(10, sampler.inf_conf.final_step - 1, -1):
        ...
        writepdb(
            out,
            denoised_xyz_stack[0, :, :4] - sampler.inf_conf.offset,
            final_seq,
            sampler.binderlen,
        ...
        if sampler.inf_conf.write_trajectory:
            ...
            writepdb_multi(
                out,
                denoised_xyz_stack - sampler.inf_conf.offset,
                bfacts,
                final_seq.squeeze(),
                use_hydrogens=False,
                backbone_only=False,
            ...
            writepdb_multi(
                out,
                px0_xyz_stack - sampler.inf_conf.offset,
                bfacts,
                final_seq.squeeze(),
                use_hydrogens=False,
                backbone_only=False,
